...
int			main(void)
{
	...
	config = cmd_ln_init(NULL, ps_args(), TRUE,
			"-hmm", "/nfs/2016/e/elee/Workspace/kift/david_rec/en-us",
			"-lm", "/nfs/2016/e/elee/Workspace/kift/david_rec/en-us.lm.bin",
			"-dict", "/nfs/2016/e/elee/Workspace/kift/david_rec/cmudict-en-us.dict",
			"-mllr", "/nfs/2016/e/elee/Workspace/kift/david_rec/mllr_matrix",
			"-logfn", "log.txt",
			"-keyphrase", "benjamin",
			"-kws_threshold", "1e-20",
			NULL);
